...
|------|---------|-------|---------|--------|-----|
| 2026-07-12 | 8queens | a11y | Found → Fixed | 13 serious color-contrast violations (0 critical); fixed by raising paper text to ~6:1 (text-ink/70), re-run clean | — |
| 2026-07-12 | 8queens | review-tests | Found → Fixed | Reviewed 1 file (solver.test.ts), found 4 gaps, added 4 tests (17 total) | — |
| 2026-07-13 | 8queens | github | Action taken | Opened issues #3–#5, labeled + commented pre-existing #1–#2 | #1–#5 |
| 2026-07-13 | 8queens | review-tests | Found — open | Coverage pass: hollow 100% (only solver.ts measured); 11 of 12 source files untested | #6, #7, #8 |
| 2026-07-13 | 8queens | language-tokens | Action taken | 45 tokens; migrated all components, App, and useQueens messages; en + he (16 he untranslated) | — |
| 2026-07-14 | 8queens | add-logging-step | Action taken | Added the logging step to 4 skills (a11y, github, language-tokens, review-tests); add-logging-step already had one | — |
